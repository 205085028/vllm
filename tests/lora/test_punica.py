...
H1 = H2 = [
    128, 256, 512, 1024, 1152, 1280, 1536, 2048, 2304, 2560, 2752, 3072, 3328,
    3456, 3584, 4096, 4608, 5120, 5504, 5632, 6144, 6400, 6848, 6912, 7168,
    8192, 9216, 10240, 11008, 13824, 14336, 22016, 24576, 27392, 32000, 32256,
    32512, 32768, 33024
]
SEED = [0xabcdabcd987]
CUDA_DEVICES = [
