...
class PagedAttention(nn.Module):
    ...
    def forward(
        ...
        # profiling run.
        #
        # With flash-attn, the key-value will be stored in the kernel.
        if key_cache is not None and value_cache is not None \
                and not input_metadata.use_flash_attn:
        ...
        if input_metadata.is_prompt and input_metadata.use_flash_attn:
            ...
            if key_cache is None or value_cache is None:
                ...
                # key-value cache will be updated
            ...
            # normal attention
            if (key_cache is None or value_cache is None
                    or input_metadata.context_lens.any()):
...
def _paged_attention(
    ...
    if input_metadata.use_flash_attn:
        ...
        output = flash_attn_with_kvcache(
            ...
            k_cache=key_cache,
            v_cache=value_cache,
            k=key.reshape(num_seqs, -1, *key.shape[1:]),
            v=value.reshape(num_seqs, -1, *value.shape[1:]),
